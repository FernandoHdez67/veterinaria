...
class ServiciossController extends Controller
{
    /**
    ...
    public function servicios()
    {
        ...
        foreach ($servicios as $servicio) {
            $imagenNombre = $servicio->imagen; // Obtener el nombre de la imagen
            $imagenRuta = url('imgservicios/' . $imagenNombre); // Obtener la URL completa de la imagen
            $servicioFormateado = [
            ...
            $serviciosFormateados[] = $servicioFormateado;
        }
    
        // Devolver los servicios formateados como respuesta
        return response()->json($serviciosFormateados);
    }
