define(["exports"], function (t) {
    ...
    let a;
    const c = () => (
        a || ((a = new o()), a.addFetchListener(), a.addCacheListener()), a
    );
    function h(t, e, n) {
        let o;
        if ("string" == typeof t) {
                ...
                f = l
                    ? await (async function (t, e, s, n) {
                          ...
                          const i = Object.assign(Object.assign({}, n), {
                              ...
                              o = await t.keys(e, i);
                          for (const e of o)
                              if (r === d(e.url, s)) return t.match(e, n);
        ...
        constructor({ precacheController: t }) {
            (this.cacheKeyWillBeUsed = async ({ request: t, params: e }) => {
                const s =
                    ...
                    this._.getCacheKeyForURL(t.url);
                ...
                });
            {
                ...
                (n = await e.fetch(
                    ...
                    s &&
                        o &&
                        "no-cors" !== t.mode &&
                        (this.W(), await e.cachePut(t, n.clone()));
            }
            return n;
        }
        async O(t, e) {
        ...
        W() {
            ...
            for (const [s, n] of this.plugins.entries())
                n !== O.copyRedirectedCacheableResponsesPlugin &&
                    (n === O.defaultPrecacheCacheabilityPlugin && (t = s),
                    n.cacheWillUpdate && e++);
            0 === e
    ...
    (t.CacheFirst = class extends m {
        ...
        (t.StaleWhileRevalidate = class extends m {
            constructor(t = {}) {
                super(t),
                    this.plugins.some((t) => "cacheWillUpdate" in t) ||
                        this.plugins.unshift(v);
            }
            async L(t, e) {
...
//# sourceMappingURL=workbox-1210ea81.js.map
