...
!(function(e, t) {
  ...
  var n = a(t),
    ...
    f = (function() {
      ...
      return (t.load = function() {
        var e = this;
        this._addOverlay(), this._settings.onLoadStart.call(
          n.default(this)
        ), n.default
          .get(
            this._settings.source,
  ...
  n.default(document).on("click", r, function(e) {
    ...
    f._jQueryInterface), (n.default.fn[i].Constructor = f), (n.default.fn[
    i
  ].noConflict = function() {
  ...
  var u = "CardWidget",
    ...
    I = (function() {
      function e(e, t) {
        (this._element = e), (this._parent = e
          .parents(".card")
          .first()), e.hasClass(g) &&
          (this._parent = e), (this._settings = n.default.extend({}, x, t));
      }
      var t = e.prototype;
      return (t.collapse = function() {
        ...
        this._parent
          ...
          .removeClass(this._settings.collapseIcon), this._element.trigger(
        ...
        this._parent
          ...
          .removeClass(this._settings.expandIcon), this._element.trigger(
          n.default.Event("expanded.lte.cardwidget"),
          this._parent
        );
      }), (t.remove = function() {
        this._parent.slideUp(), this._element.trigger(
        ...
        this._parent
          ...
          .removeClass(this._settings.maximizeIcon), this._parent
          .css({
          ...
          .queue(function() {
            ...
            e.addClass(
              b
            ), n.default("html").addClass(b), e.hasClass(p) && e.addClass(_), e.dequeue();
        ...
        this._parent
          ...
          .removeClass(this._settings.minimizeIcon), this._parent
          .css(
            "cssText",
            "height: " +
          ...
          .queue(function() {
            ...
            e.removeClass(
              b
            ), n.default("html").removeClass(b), e.css({ height: "inherit", width: "inherit" }), e.hasClass(_) && e.removeClass(_), e.dequeue();
          }), this._element.trigger(
  ...
  n.default(document).on("click", C, function(e) {
    ...
    e &&
      e.preventDefault(), I._jQueryInterface.call(n.default(this), "toggleMaximize");
  }), (n.default.fn[u] =
    I._jQueryInterface), (n.default.fn[u].Constructor = I), (n.default.fn[
    u
  ].noConflict = function() {
    ...
    M = (function() {
      ...
      return (t.collapse = function() {
        ...
        this._config.controlsidebarSlide
          ? (
              a.addClass(E),
              t.removeClass(D).delay(300).queue(function() {
                n
                  .default(k)
                  .hide(), a.removeClass(E), n.default(this).dequeue();
              })
            )
          : t.removeClass(L), n
          .default(this._element)
          .trigger(
            n.default.Event("collapsed.lte.controlsidebar")
          ), setTimeout(function() {
          n
            .default(e._element)
            .trigger(n.default.Event("collapsed-done.lte.controlsidebar"));
        }, this._config.animationSpeed);
      }), (t.show = function(e) {
        void 0 === e && (e = !1);
        var t = n.default("body"),
          a = n.default("html");
        e && n.default(k).hide(), this._config.controlsidebarSlide
          ? (
              a.addClass(E),
              n.default(this._config.target).show().delay(10).queue(function() {
          ...
          : t.addClass(
              L
            ), this._fixHeight(), this._fixScrollHeight(), n
          .default(this._element)
        ...
        t.hasClass(L) || t.hasClass(D)
          ...
          : n
              .default(k)
              .hide(), this._fixHeight(), this._fixScrollHeight(), n
          .default(window)
          .resize(function() {
        ...
        if (e.hasClass(R)) {
          var a = {
            ...
            l =
              this._isNavbarFixed() && "fixed" === n.default(z).css("position"),
            s =
              this._isFooterFixed() && "fixed" === n.default(F).css("position"),
            r = n.default(
              this._config.target + ", " + this._config.target + " " + Q
            );
          if (0 === o && 0 === i)
            t.css({ bottom: a.footer, top: a.header }), r.css(
              "height",
              a.window - (a.header + a.footer)
            );
          else if (i <= a.footer)
            if (!1 === s) {
              var d = a.header - o;
              t.css("bottom", a.footer - i).css("top", d >= 0 ? d : 0), r.css(
                "height",
                a.window - (a.footer - i)
              );
        ...
        if (e.hasClass(R)) {
          ...
          this._isFooterFixed() &&
            ...
            (l = a - i - o), t.css("height", l), "undefined" !=
            typeof n.default.fn.overlayScrollbars &&
            t.overlayScrollbars({
  ...
  n.default(document).on("click", H, function(e) {
    ...
    M._jQueryInterface), (n.default.fn[T].Constructor = M), (n.default.fn[
    T
  ].noConflict = function() {
    ...
    P = (function() {
      ...
      return (e.prototype.toggle = function() {
        n
          ...
          .parents(".direct-chat")
          .first()
          .toggleClass("direct-chat-contacts-open"), n
          .default(this._element)
        ...
        return this.each(function() {
          var a = n.default(this).data(O);
          a ||
            ((a = new e(n.default(this))), n.default(this).data(O, a)), a[t]();
        });
      }), e;
    })();
  n
    ...
    .on("click", '[data-widget="chat-pane-toggle"]', function(e) {
      e &&
        e.preventDefault(), P._jQueryInterface.call(n.default(this), "toggle");
    }), (n.default.fn[q] =
    P._jQueryInterface), (n.default.fn[q].Constructor = P), (n.default.fn[
    q
  ].noConflict = function() {
    ...
    V = (function() {
      ...
      return (t.toggleSubmenu = function() {
        this._element
          .siblings()
          .show()
          .toggleClass("show"), this._element.next().hasClass("show") ||
          this._element
            .parents(J)
            .first()
            .find(".show")
  ...
  n.default('.dropdown-menu [data-toggle="dropdown"]').on("click", function(e) {
    ...
    V._jQueryInterface), (n.default.fn[U].Constructor = V), (n.default.fn[
    U
  ].noConflict = function() {
    ...
    te = (function() {
      ...
      return (t.init = function() {
        ...
        return this.each(function() {
          ...
          a ||
            (
              (a = new e(n.default(this))),
              n.default(this).data(K, a)
  ...
  n.default(".expandable-table").ready(function() {
    ...
    te._jQueryInterface), (n.default.fn[G].Constructor = te), (n.default.fn[
    G
  ].noConflict = function() {
  ...
  var ae = "Fullscreen",
    ...
    re = (function() {
      ...
      return (t.toggle = function() {
        ...
        n.default(this).data(ne, "object" == typeof t ? t : a), "string" ==
          typeof t && /toggle|toggleIcon|fullscreen|windowed/.test(t)
          ? o[t]()
          : o.init();
      }), e;
    })();
  n.default(document).on("click", oe, function() {
    ...
    ), (n.default.fn[ae] = re._jQueryInterface), (n.default.fn[ae].Constructor = re), (n.default.fn[
    ae
  ].noConflict = function() {
  ...
  var de = "lte.iframe",
    ...
    Qe = (function() {
      ...
      return (t.onTabClick = function(e) {
        ...
        void 0 === a.attr("href") &&
          (a = n.default(e).parent("a").clone()), a
          .find(".right, .search-path")
          .remove();
        var i = a.find("p").text();
        "" === i && (i = a.text());
        var o = a.attr("href");
        ...
        n
          .default(me + " .active")
          .tab("dispose")
          .removeClass("active"), this._fixHeight(), i.tab("show"), i
          .parents("li")
          .addClass("active"), this.onTabChanged(i), this._config
          .autoItemActive &&
        ...
        if ("all" == e)
          ...
          n.default(ve + ":not(.active)").remove(), n
            .default(we + ":not(.active)")
            .remove();
        else if ("only-this" == e) {
          var a = n.default(t),
            i = a.parent(".nav-item"),
        ...
        n.default("body").hasClass(je)
          ...
          : (
            ...
            ), n.default(window).trigger("resize"), this._fixHeight(!0);
      }), (t._init = function() {
        ...
        n.default(window).on("resize", function() {
          ...
          .on("click", '[data-widget="iframe-close"]', function(t) {
            ...
            "I" == a.nodeName &&
              (a =
                t.target
                  .offsetParent), e.removeActiveTab(a.attributes["data-type"] ? a.attributes["data-type"].nodeValue : null, a);
        ...
        n
          ...
          .on("mousedown", '[data-widget="iframe-scrollleft"]', function(n) {
            ...
            e._config.scrollBehaviorSwap ||
              (i = -i), (t = !0), e._navScroll(i), (a = setInterval(function() {
              e._navScroll(i);
            }, 250));
          }), n
          .default(document)
          .on("mousedown", '[data-widget="iframe-scrollright"]', function(n) {
            n.preventDefault(), clearInterval(a);
            var i = e._config.scrollOffset;
            e._config.scrollBehaviorSwap &&
              (i = -i), (t = !0), e._navScroll(i), (a = setInterval(function() {
        ...
        n.default(xe + ", " + Te).removeClass("active"), n
          .default(Ie)
          .parent()
          .removeClass("active");
        ...
        if ((void 0 === e && (e = !1), n.default("body").hasClass(je))) {
          ...
          n.default(ye + ", " + Ce + ", " + ge).height(t - a), n
            .default(he)
            .height(t);
        } else {
        ...
        if (n.default(ue).length > 0) {
          ...
          n.default(this).data(de, "object" == typeof t ? t : a), "string" ==
            typeof t &&
  ...
  n.default(window).on("load", function() {
    ...
    Qe._jQueryInterface), (n.default.fn.IFrame.Constructor = Qe), (n.default.fn.IFrame.noConflict = function() {
    ...
    Me = (function() {
      ...
      return (t.fixLayoutHeight = function(e) {
        ...
        if (e.hasClass("iframe-mode"))
          e.css("height", "100%"), n
            .default(".wrapper")
            .css("height", "100%"), n.default("html").css("height", "100%");
        else if (0 === t.length)
        ...
        var e = this;
        this.fixLayoutHeight(), !0 === this._config.loginRegisterAutoHeight
        ...
        return void 0 === t && (t = ""), this.each(function() {
          ...
          a ||
            (
              (a = new e(n.default(this), i)),
              n.default(this).data(He, a)
            ), "init" === t || "" === t ? a._init() : ("fixLayoutHeight" !== t && "fixLoginRegisterHeight" !== t) || a[t]();
        });
      }), e;
    })();
  n.default(window).on("load", function() {
    ...
    Me._jQueryInterface), (n.default.fn.Layout.Constructor = Me), (n.default.fn.Layout.noConflict = function() {
  ...
  var qe = "PushMenu",
    ...
    Ke = (function() {
      function e(e, t) {
        (this._element = e), (this._options = n.default.extend(
          {},
          Ge,
          t
        )), 0 === n.default("#sidebar-overlay").length &&
          this._addOverlay(), this._init();
      }
      var t = e.prototype;
      return (t.expand = function() {
        ...
        this._options.autoCollapseSize &&
          ...
          localStorage.setItem("remember" + Ne, Je), n
          .default(this._element)
        ...
        this._options.autoCollapseSize &&
          n.default(window).width() <= this._options.autoCollapseSize &&
          t.removeClass(Je).addClass(Ve), t.addClass($e), this._options
          .enableRemember &&
          localStorage.setItem("remember" + Ne, $e), n
          .default(this._element)
          .trigger(
            n.default.Event("collapsed.lte.pushmenu")
          ), setTimeout(function() {
          n
            .default(e._element)
            .trigger(n.default.Event("collapsed-done.lte.pushmenu"));
        ...
        var e = this;
        this.remember(), this.autoCollapse(), n
          .default(window)
          .resize(function() {
            e.autoCollapse(!0);
          });
  ...
  n.default(document).on("click", Ue, function(e) {
    ...
    "pushmenu" !== n.default(t).data("widget") &&
      (t = n
        .default(t)
        .closest(Ue)), Ke._jQueryInterface.call(n.default(t), "toggle");
  }), n.default(window).on("load", function() {
    Ke._jQueryInterface.call(n.default(Ue));
  }), (n.default.fn[qe] =
    Ke._jQueryInterface), (n.default.fn[qe].Constructor = Ke), (n.default.fn[
    qe
  ].noConflict = function() {
  ...
  var Xe = "SidebarSearch",
    ...
    ht = (function() {
      function e(e, t) {
        (this.element = e), (this.options = n.default.extend(
          {},
          ut,
          t
        )), (this.items = []);
      ...
      return (a.init = function() {
        ...
        n.default(ot).parent().addClass(et), n
          .default(rt)
          .removeClass(tt)
          .addClass(at);
      }), (a.close = function() {
        n.default(ot).parent().removeClass(et), n
          .default(rt)
          .removeClass(at)
          .addClass(tt);
      }), (a.toggle = function() {
        ...
        n
          .default(ft)
          .append(this._renderItem(this.options.notFoundText, "#", []));
      }), (e._jQueryInterface = function(t) {
        var a = n.default(this).data(Ye);
        a || (a = n.default(this).data());
        var i = n.default.extend({}, ut, "object" == typeof t ? t : a),
          o = new e(n.default(this), i);
        n.default(this).data(Ye, "object" == typeof t ? t : a), "string" ==
          typeof t && /init|toggle|close|open|search/.test(t)
          ? o[t]()
          : o.init();
      }), e;
    })();
  n.default(document).on("click", st, function(e) {
    ...
    38 == e.keyCode &&
      ...
      ), 40 == e.keyCode && (e.preventDefault(), t.is(":last-child") ? t.siblings().first().focus() : t.next().focus());
  }), n.default(window).on("load", function() {
    ht._jQueryInterface.call(n.default(ot), "init");
  }), (n.default.fn[Xe] =
    ht._jQueryInterface), (n.default.fn[Xe].Constructor = ht), (n.default.fn[
    Xe
  ].noConflict = function() {
    ...
    Ct = (function() {
      ...
      return (t.open = function() {
        n
          ...
          .hide()
          .fadeIn()
          .addClass(bt), n.default(this._config.target + " " + _t).focus();
      }), (t.close = function() {
        n.default(this._config.target).fadeOut().removeClass(bt), this._config
          .resetOnClose && n.default(this._config.target + " " + _t).val("");
      }), (t.toggle = function() {
  ...
  n.default(document).on("click", vt, function(e) {
    ...
    "navbar-search" !== t.data("widget") &&
      (t = t.closest(vt)), Ct._jQueryInterface.call(t, "toggle");
  }), (n.default.fn[gt] =
    Ct._jQueryInterface), (n.default.fn[gt].Constructor = Ct), (n.default.fn[
    gt
  ].noConflict = function() {
  ...
  var wt = n.default.fn.Toasts,
    ...
    kt = (function() {
      function e(e, t) {
        (this._config = t), this._prepareContainer(), n
          .default("body")
          .trigger(n.default.Event("init.lte.toasts"));
      }
      var t = e.prototype;
      return (t.create = function() {
        ...
        e.data("autohide", this._config.autohide), e.data(
          "animation",
          this._config.fade
        ), this._config.class && e.addClass(this._config.class), this._config
          .delay &&
        ...
        if (null != this._config.image) {
          ...
          null != this._config.imageHeight &&
            a.height(this._config.imageHeight).width("auto"), t.append(a);
        }
        if (
          (
          ...
          null == this._config.title && i.toggleClass("ml-2 ml-auto"), t.append(
            i
          );
        }
        e.append(t), null != this._config.body &&
          e.append(
            n.default('<div class="toast-body" />').html(this._config.body)
          ), n.default(this._getContainerId()).prepend(e);
        var o = n.default("body");
        o.trigger(n.default.Event("created.lte.toasts")), e.toast("show"), this
          ._config.autoremove &&
          e.on("hidden.bs.toast", function() {
            n
              .default(this)
              .delay(200)
              .remove(), o.trigger(n.default.Event("removed.lte.toasts"));
          });
          ...
          this._config.position == xt
            ...
            : this._config.position == It
              ...
              : this._config.position == Tt
                ...
                : this._config.position == St &&
                  e.addClass("toasts-bottom-left"), n.default("body").append(e);
        }
        this._config.fixed
  ...
  (n.default.fn.Toasts =
    kt._jQueryInterface), (n.default.fn.Toasts.Constructor = kt), (n.default.fn.Toasts.noConflict = function() {
  ...
  var Qt = "TodoList",
    ...
    Lt = (function() {
      ...
      return (t.toggle = function(e) {
        e.parents("li").toggleClass(Ft), n.default(e).prop("checked")
          ? this.check(e)
        ...
        t
          ...
          .parents("li")
          .toggleClass(Ft), t.on("change", "input:checkbox", function(t) {
        ...
        return this.each(function() {
          ...
          n
            .default(this)
            .data(Ht, "object" == typeof t ? t : a), "init" === t && o[t]();
        });
      }), e;
    })();
  n.default(window).on("load", function() {
    ...
    Lt._jQueryInterface), (n.default.fn[Qt].Constructor = Lt), (n.default.fn[
    Qt
  ].noConflict = function() {
    ...
    $t = (function() {
      ...
      return (t.init = function() {
        n
          ...
          .css("display", "block"), this._setupListeners();
        ...
        t.removeClass("menu-is-opening menu-open"), e
          .stop()
          .slideUp(this._config.animationSpeed, function() {
            n
              ...
              .trigger(
                i
              ), e.find(".menu-open > .nav-treeview").slideUp(), e.find(Ot).removeClass("menu-is-opening menu-open");
          });
      }), (t.toggle = function(e) {
        var t = n.default(e.currentTarget),
          a = t.parent(),
        ...
        n
          .default(document)
          .on("click", "" + t + this._config.trigger, function(t) {
            e.toggle(t);
          });
  ...
  n.default(window).on("load.lte.treeview", function() {
    ...
    $t._jQueryInterface), (n.default.fn[Dt].Constructor = $t), (n.default.fn[
    Dt
  ].noConflict = function() {
    return (n.default.fn[Dt] = At), $t._jQueryInterface;
  }), (e.CardRefresh = f), (e.CardWidget = I), (e.ControlSidebar = M), (e.DirectChat = P), (e.Dropdown = V), (e.ExpandableTable = te), (e.Fullscreen = re), (e.IFrame = Qe), (e.Layout = Me), (e.NavbarSearch = Ct), (e.PushMenu = Ke), (e.SidebarSearch = ht), (e.Toasts = kt), (e.TodoList = Lt), (e.Treeview = $t), Object.defineProperty(e, "__esModule", { value: !0 });
});
